...
export function isValidKeymapObject(obj: unknown): obj is KeymapObject {
  ...
  if (typeof o.device !== "object" || o.device === null) return false;
  const device = o.device as Record<string, unknown>;
  if (typeof device.name !== "string" || typeof device.manufacturer !== "string") return false;
  if (typeof o.service !== "string") return false;
  if (!Array.isArray(o.mappings)) return false;
